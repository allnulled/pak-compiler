...
//    - time:         0.013 seconds
//    - modules:      2
//       - 0. Pak.require("04. Environment dependant modules test/environments/server/module.js")
//       - 1. Pak.require("04. Environment dependant modules test/entries/server.js")
//    - styles:       0
//    - templates:    0
// @module[main] = Pak
(function(globalPak) {
  ...
  // @module[1] = 04. Environment dependant modules test/environments/server/module.js
  (function(module) {
    try {
      module.exports = "server";
    } catch (error) {
      console.log("⛔️ Error on module 04. Environment dependant modules test/environments/server/module.js\n  ", error);
      throw error;
    } finally {
      __LAST_PAK_RESULT__ = Pak.modules["04. Environment dependant modules test/environments/server/module.js"] = module.exports;
    }
  })({
    exports: undefined
  });
  // @module[2] = 04. Environment dependant modules test/entries/server.js
  (function(module) {
    try {
      module.exports = Pak.require("04. Environment dependant modules test/environments/server/module.js");
    } catch (error) {
      console.log("⛔️ Error on module 04. Environment dependant modules test/entries/server.js\n  ", error);
      throw error;
    } finally {
      __LAST_PAK_RESULT__ = Pak.modules["04. Environment dependant modules test/entries/server.js"] = module.exports;
    }
  })({
    exports: undefined
  });
