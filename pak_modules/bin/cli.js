...
PakCompiler.assert(args0.length > 0, `Command «pak» requires at least 1 parameter for the command but 0 were found by command line arguments on «pak»`);
