...
const colorsPath = path.resolve(projectRoot, "pak_modules/src/pak.cmd.colors.js");
const colors = require(colorsPath);
PakCompiler.global.setBasedir(path.resolve(projectRoot, "pak_modules"));
const argumentsParser = require(PakCompiler.global.basedir + "/src/pak.cmd.parseArgsIntoObject.js");
